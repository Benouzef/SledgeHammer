...
import { signInWithGoogleAsync } from './src/utilities/google';
...
export default class McFireBaseApp extends Component {
  constructor(props) {
    super(props);
...
AppRegistry.registerComponent('mcfirebaseapp', () => McFireBaseApp);
